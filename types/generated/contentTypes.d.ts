...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    docs: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ethics_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    ethics_list: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ethics_list_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ethics_slogan: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    herosection_description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    mission_list: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    mission_list_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    mission_slogan: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    mission_slogan_description: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    partners_images: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    publishedAt: Schema.Attribute.DateTime;
    quote_contacts_title: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    quote_email: Schema.Attribute.Email &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    quote_fio: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    quote_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    quote_number: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    quote_position: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNumbers21Numbers21 extends Struct.CollectionTypeSchema {
...
export interface ApiNumbers22Numbers22 extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    number_desc: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNumbers23Numbers23 extends Struct.SingleTypeSchema {
  collectionName: 'numbers_2_3s';
  info: {
    displayName: 'Numbers 2.3';
    pluralName: 'numbers-2-3s';
    singularName: 'numbers-2-3';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiNumbers24Numbers24 extends Struct.SingleTypeSchema {
  collectionName: 'numbers_2_4s';
  info: {
    description: '';
    displayName: 'Numbers 2.4';
    pluralName: 'numbers-2-4s';
    singularName: 'numbers-2-4';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiNumbers3Numbers3 extends Struct.SingleTypeSchema {
  collectionName: 'numbers_3s';
  info: {
    description: '';
    displayName: 'Numbers 3';
    pluralName: 'numbers-3s';
    singularName: 'numbers-3';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPageClientPageClient extends Struct.SingleTypeSchema {
...
export interface ApiPageHistoryPageHistory extends Struct.SingleTypeSchema {
  collectionName: 'page_histories';
  info: {
    description: '';
    displayName: 'Page history';
    pluralName: 'page-histories';
    singularName: 'page-history';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    first_img: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    herosection: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wall: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPhonePhone extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    phone_3: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::numbers-2-1.numbers-2-1': ApiNumbers21Numbers21;
      'api::numbers-2-2.numbers-2-2': ApiNumbers22Numbers22;
